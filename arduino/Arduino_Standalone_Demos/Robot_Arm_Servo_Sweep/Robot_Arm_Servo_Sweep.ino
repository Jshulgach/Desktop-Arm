...
ServoAction retract_Actions[] = {
  ...
  {1000,    Shoulder, false,     0,    45},
  {1000,        Claw, false,   180,   180},
  {2000,       Elbow, false,     0,     0}, 
  {9000,    WristRot, false,     0,    90},
  {10000,   WristBend, false,     0,     0},
  {10000,       Torso, false,     0,     0},
  {11000,       Torso, false,   180,   90},
  /* etc. etc. */
};
