...
def generate_launch_description():
    ...
    declared_arguments.append(DeclareLaunchArgument("start_server", default_value="true", description="Start the socket server listenning for remote control commands from the ddns"))
    declared_arguments.append(DeclareLaunchArgument("manual", default_value="false", description="Assume manual control into Raspberry pi with xbox controller, keyboard, etc."))
